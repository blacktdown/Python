...
# any() : 리스트에서 True값이 하나라도 있으면 전체True, 모두 False이면 전체 Flase가 되는 함수
list3 = [0, 1, 2, 3]
list4 = [0, '', None]
...
# enumerate() : for문에서 리스트의 인덱스와 값을 리턴(출력)하는 함수
list5 = ['김유신', '김춘추', '장보고']
...
num2 = num1 * 10
print('num2 : ', num2) # 1 ~ 10 사이의 실수

num3 = math.ceil(num2)
print('num3 : ', num3) # 1 ~ 사이 정수
